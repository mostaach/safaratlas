  ...
  return (
    <div className="space-y-3">
      <button
        onClick={handleAdd}
        disabled={added}
        className="w-full py-4 rounded-xl bg-[#C4A258] hover:bg-[#d8bb78] text-[#07192d] text-xs font-normal tracking-[0.18em] shadow-lg transition-all transform hover:-translate-y-0.5 flex flex-col items-center justify-center gap-1 text-center cursor-pointer disabled:opacity-70"
      >
