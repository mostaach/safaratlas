          ...
          <div className="w-full lg:w-[360px] flex-shrink-0 space-y-5 lg:sticky lg:top-28">
            ...
            <div className="bg-[#051324] border border-white/15 p-6 space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-xs uppercase tracking-widest py-4 transition-all"
              >
              ...
              <Link
                href="/journey"
                className="w-full flex items-center justify-center gap-2 bg-[#C4A258] hover:bg-[#d8bb78] text-[#07192d] font-bold text-xs uppercase tracking-widest py-3.5 transition-all"
              >
