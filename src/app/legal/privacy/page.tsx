      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <SlideUp delay={0.1}>
            ...
            <h1 className="text-3xl sm:text-5xl font-serif font-black text-[#f6f2ec] tracking-tight">Privacy Policy</h1>
          ...
          <SlideUp delay={0.2}>
            <div className="prose prose-invert prose-a:text-[#C4A258] hover:prose-a:text-[#d8bb78] prose-headings:text-[#f6f2ec] prose-headings:font-serif max-w-none text-[#f6f2ec]/80 leading-relaxed space-y-4">
              ...
              <h3 className="text-xl font-bold text-[#f6f2ec] pt-4">Information We Collect</h3>
              ...
              <h3 className="text-xl font-bold text-[#f6f2ec] pt-4">How We Share Information</h3>
              ...
              <h3 id="cookies" className="text-xl font-bold text-[#f6f2ec] pt-4 scroll-mt-28">Cookies & Tracking Technologies</h3>
              ...
              <h4 className="text-lg font-bold text-[#f6f2ec] pt-3">Managing Your Cookie Preferences & Google Consent Mode</h4>
              ...
              <h3 className="text-xl font-bold text-[#f6f2ec] pt-4">Analytics</h3>
              ...
              <h3 className="text-xl font-bold text-[#f6f2ec] pt-4">Your Rights & Data Protection (GDPR / CNDP)</h3>
              ...
              <p>To exercise your rights or ask questions regarding our privacy practices, contact us directly at <a href="mailto:contactsafaratlas@gmail.com" className="text-[#C4A258] underline">contactsafaratlas@gmail.com</a>.</p>
            </div>
          </SlideUp>
        </div>
      </main>
