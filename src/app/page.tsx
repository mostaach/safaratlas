          ...
          <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#07192d]/95 backdrop-blur-xl border-t border-[#C4A258]/20 px-4 py-3 flex items-center justify-between shadow-2xl">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2.5 rounded-none bg-[#25D366] text-white flex items-center justify-center shadow-md active:scale-95 transition-all"
              ...
              <a
                href="/journey"
                className="px-4 py-2.5 rounded-none bg-[#C4A258] text-[#07192d] text-xs font-normal uppercase tracking-[0.18em] shadow-lg active:scale-95 transition-all flex items-center gap-1"
              >
