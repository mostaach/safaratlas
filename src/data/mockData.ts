...
export const BUSINESS_LISTINGS: BusinessListing[] = [
  {
    ...
    reviewCount: 342,
    responseTime: "< 1 hour",
    directInquiryMargin: "SafarAtlas Guaranteed Rate",
    priceRange: "$$$",
    ...
    shortDesc: "A meticulously restored 17th-century riad offering peaceful courtyards, authentic zellige tilework, and a rooftop overlooking the Koutoubia.",
    fullDesc: "Hidden deep within the vibrant Marrakech medina, Riad Dar Zellige offers a sanctuary of calm. Features hand-carved stucco, a heated plunge pool, and traditional hammam spa services. Perfect base for exploring the red city.",
    amenities: ["Plunge Pool", "Rooftop Restaurant", "Traditional Hammam", "Medina Transfers"],
    contactWhatsapp: "+212600000001",
    leadCountThisMonth: 12,
  },
  {
    id: "sahara-sky-camp",
    name: "Sahara Sky Luxury Camp",
    ...
    shortDesc: "Premium Bedouin-style tents nestled deep in the Erg Chebbi dunes featuring ensuite bathrooms and stargazing terraces.",
    fullDesc: "Experience the majesty of the Sahara in uncompromising comfort. Private 4x4 transfers, sunset camel treks, and candlelit dinners under the Milky Way. Each canvas tent includes running water, flush toilets, and hot showers.",
    amenities: ["Ensuite Bathrooms", "Camel Trekking", "Gnaoua Music", "Sandboarding"],
    contactWhatsapp: "+212600000002",
    leadCountThisMonth: 24,
  },
  {
    id: "amouage-surf",
    name: "Amouage Surf & Yoga Retreat",
    category: "Surf & Ocean",
    location: "Anchor Point, Taghazout",
    region: "Atlantic Coast",
    verified: true,
    ...
    shortDesc: "Boutique oceanfront surf camp combining daily ISA-certified coaching with sunset rooftop yoga sessions.",
    fullDesc: "Wake up to the sound of crashing waves at Anchor Point. Amouage offers tailored surf programs for all levels, daily yoga overlooking the Atlantic, and healthy farm-to-table Moroccan fusion cuisine.",
    amenities: ["Oceanfront Pool", "Surf Rentals & Coaching", "Yoga Shala", "Board Storage"],
    contactWhatsapp: "+212600000003",
    leadCountThisMonth: 45,
  },
  {
    id: "kasbah-ait-ben-dades",
    name: "Kasbah Ait Ben Dades",
    category: "Riad & Stay",
    ...
    shortDesc: "Traditional rammed-earth kasbah offering dramatic views over the Dades Gorge and authentic Berber hospitality.",
    fullDesc: "The perfect overnight stop between Marrakech and the Sahara. This family-run kasbah serves home-cooked organic meals from their valley garden and offers guided hikes through the spectacular monkey fingers rock formations.",
    amenities: ["Valley Views", "Organic Garden", "Guided Hiking", "Free Parking"],
    contactWhatsapp: "",
    leadCountThisMonth: 8,
  },
  {
    id: "blue-pearl-guesthouse",
    name: "Blue Pearl Artisan House",
    category: "Riad & Stay",
    location: "Old Medina, Chefchaouen",
    region: "Rif Mountains",
    verified: true,
    verifiedBadgeType: "Gold Partner",
    rating: 4.9,
    ...
    shortDesc: "A vibrant blue-washed guesthouse tucked in the quietest part of Chefchaouen, famous for its mountain terrace breakfasts.",
    fullDesc: "Step into the iconic blue aesthetic of Chefchaouen. Decorated with authentic Rif mountain textiles, this guesthouse features a panoramic terrace where a legendary homemade goat cheese and mountain honey breakfast is served daily.",
    amenities: ["Panoramic Terrace", "Rif Breakfast", "Artisan Shop", "Heated Rooms"],
    contactWhatsapp: "+212600000005",
